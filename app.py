...
crypto_mapping = {"Bitcoin": "BTC-USD", "Ethereum": "ETH-USD", "Litecoin": "LTC-USD", "Binance": "BNB-USD"}

st.title("Crypto Tracker")
crypto_option = st.sidebar.selectbox(
    "Which Crypto do you want to visualize?", ("Bitcoin", "Ethereum", "Litecoin", "Binance")
)
